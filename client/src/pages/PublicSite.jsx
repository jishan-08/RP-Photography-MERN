...
export default function PublicSite() {
  ...
  useEffect(() => {
    ...
    api("/api/content")
      ...
      .catch((error) => {
        console.warn(
          "API content fetch failed; using initial content:",
          error?.message
        );
      });
  ...
  useEffect(() => {
    return () => cancelAnimationFrame(heroFrame.current);
  }, []);
  ...
  const heroImage = s.heroImages?.[0]
    ? assetUrl(s.heroImages[0])
    : null;
  ...
  return (
    <div className="public-site">
      ...
      <nav className="site-nav">
        <button className="brand" onClick={openLoginModal}>
          <b>RP</b>
      ...
      <main>
        ...
        <section id="about" className="section story">
          <div className="story-images">
            <img
              ...
              src={assetUrl(s.storyImages?.[0])}
              alt="Photographer at work"
            />

            <img
              className="story-float"
              src={assetUrl(s.storyImages?.[1])}
              alt="Camera and creative process"
            />
          </div>
        ...
        >
          <SectionHeading
            ...
            title="Photography with feeling, craft, and intention."
            text="From intimate portraits to multi-day celebrations, every commission is shaped around your story."
            align="center"
          />
        ...
        >
          <div className="heading-row">
            <SectionHeading
              ...
              text="A small window into celebrations, portraits, and places we have loved photographing."
            />
        ...
        >
          <div>
            ...
            <h2>Your story, told in motion.</h2>

            <p>
              Wedding films built from real voices,
              fleeting gestures, and the beautiful noise
              around them.
            </p>
        ...
        >
          <div className="contact-copy">
            ...
            <p>
              Share your date, place, and the feeling you
              want to remember. We will reply with
          ...
          <form onSubmit={submitInquiry}>
            ...
            <label className="wide">
              ...
              <textarea
                name="message"
                rows="4"
                placeholder="Location, events, guest count, mood..."
              />
            </label>
      ...
      {openLogin && (
        ...
        >
          ...
          >
            ...
            <p>
              Enter your admin username and password to
              continue.
            </p>
      ...
      <footer>
        ...
        <p>
          Stories made timeless through creativity,
          calm direction, and an eye for honest moments.
        </p>
        ...
        <small>
          © {new Date().getFullYear()} RP Photography.
          All rights reserved.{" "}
      ...
      {lightbox !== null && (
        ...
        >
          ...
          <img
            src={assetUrl(gallery[lightbox]?.image)}
