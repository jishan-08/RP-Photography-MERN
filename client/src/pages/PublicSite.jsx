...
export default function PublicSite() {
  ...
  useEffect(() => {
    ...
    api("/api/content")
      ...
      .catch((error) => {
        console.warn("API content fetch failed; using initial content:", error?.message);
      });
    return () => {
      isMounted = false;
    };
...
<<<<<<< HEAD
  ...
  const heroImage = s.heroImages?.[0] ? assetUrl(s.heroImages[0]) : null;

>>>>>>> c0428ee (problem of landing pages , server problem solved ,Fix hero image loading behavior)
